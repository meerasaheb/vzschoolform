...
RSpec.describe "classessections/edit", type: :view do
  before(:each) do
  ...
  it "renders the edit classessection form" do
    render

    assert_select "form[action=?][method=?]", classessection_path(@classessection), "post" do
